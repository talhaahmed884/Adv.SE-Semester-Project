 ...
 */
public class UC_9_6_13_MarkInComplete_Performance_O1_Test extends BaseIntegrationTest {
    @Autowired
    ...
    public void testMarkInCompletePerformanceO1() {
        ...
        // Act - Measure time to mark task as incomplete
        long startTime = System.currentTimeMillis();
        ToDoListTaskDTO result = toDoListService.markTaskInComplete(todoList.getId(), task.getId());
        ...
        assertTrue(duration < 100, "markInComplete took " + duration + "ms, expected < 100ms for O(1) operation");
    }
}
