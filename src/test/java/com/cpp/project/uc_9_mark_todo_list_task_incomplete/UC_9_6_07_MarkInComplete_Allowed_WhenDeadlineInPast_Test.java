 ...
 */
public class UC_9_6_07_MarkInComplete_Allowed_WhenDeadlineInPast_Test extends BaseIntegrationTest {
    @Autowired
    ...
    public void testMarkInCompleteAllowedWhenDeadlineInPast() throws InterruptedException {
        ...
        // Act - Mark task as incomplete (after deadline conceptually)
        result = toDoListService.markTaskInComplete(todoList.getId(), task.getId());

        // Assert - Should incomplete successfully (no exception for late completion)
        assertNotNull(result);
