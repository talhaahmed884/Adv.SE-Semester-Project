 ...
 */
public class UC_9_6_12_MarkInComplete_Robust_DespiteNullOptionalFields_Test extends BaseIntegrationTest {
    @Autowired
    ...
    public void testMarkInCompleteRobustDespiteNullOptionalFields() {
        ...
        // Act - Mark task as incomplete (should handle null fields gracefully)
        result = toDoListService.markTaskInComplete(todoList.getId(), task.getId());

        // Assert - Should incomplete without NPE
        assertNotNull(result);
