...
public class UC_9_6_14_MarkInComplete_WhenRepositoryFails_Test {
    @Mock
    ...
    public void testMarkInCompleteWhenRepositoryFails() {
        // Arrange
        ...
        // Act & Assert
        ToDoListException exception = assertThrows(ToDoListException.class, () -> toDoListService.markTaskInComplete(todoListId, taskId));
    ...
    public void testMarkInCompleteWhenToDoListNotFound() {
        // Arrange
        UUID todoListId = UUID.randomUUID();
        UUID taskId = UUID.randomUUID();
    ...
    public void testMarkInCompleteWhenTaskNotFound() {
        // Arrange
        UUID todoListId = UUID.randomUUID();
        ...
        // Act & Assert
        ToDoListException exception = assertThrows(ToDoListException.class, () -> toDoListService.markTaskInComplete(todoListId, nonExistentTaskId));
