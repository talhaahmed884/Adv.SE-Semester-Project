...
/**
 * UC-10.14: Month < 0 are rejected
 */
public class UC_10_14_ItemsForMonth_Fail_InvalidMonthNegative_Test extends BaseIntegrationTest {
    @Autowired
    ...
    @Test
    @DisplayName("UC-10.14: Throws exception for negative month")
    public void testItemsForMonthFailInvalidMonthNegative() {
        // Arrange
        UserDTO user = authenticationService.signUp(new SignUpRequestDTO(
                "Test User",
                "calendar.uc1014@test.com",
                "Password123!"
        ));
