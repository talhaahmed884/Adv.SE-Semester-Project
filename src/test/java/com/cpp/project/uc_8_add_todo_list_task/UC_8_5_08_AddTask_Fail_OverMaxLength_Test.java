...
/**
 * UC-8.5.08: Description > 500 chars rejected
 */
public class UC_8_5_08_AddTask_Fail_OverMaxLength_Test extends BaseIntegrationTest {
    @Autowired
    ...
    @Test
    @DisplayName("UC-8.5.08: Reject description with 501 characters (exceeds 500 limit)")
    public void testAddTaskFailOverMaxLength() {
        // Arrange - Create a test user
        UserDTO user = authenticationService.signUp(new SignUpRequestDTO(
                "Test User",
                "test.user.task.uc8508@test.com",
                "Password123!"
        ));
        ...
        assertTrue(exception.getMessage().toLowerCase().contains("description") ||
                ...
                exception.getMessage().toLowerCase().contains("5001"));
    }
}
